<template>
  <div class="pro_item">
    <h4 class="item_title"><span>跨境商城自营店</span><span class="item_one">{{goods.price / 100 | moneyFormat}}</span></h4>
    <div class="item_content">
      ...
      <div v-if="goods.counts <= 0" class="item-info">该商品库存为0，无法购买，请联系管理员</div>
